...
// ** Text Style Nike Text .
  TextStyle nikeTextStyleText(Size size) {
    return TextStyle(
  ...
  TextStyle boldText1TextStyle(Size size) {
    return TextStyle(
  ...
  TextStyle boldText2TextStyle(Size size) {
    return TextStyle(
      fontSize: size.height * 0.05,
      fontWeight: FontWeight.w500,
      color: Resources.colors.kLargeTextColor,
  ...
  TextStyle smallText1TextStyle(Size size) {
    return TextStyle(
  ...
  TextStyle smallText2TextStyle(Size size) {
    return TextStyle(
      fontSize: size.height * 0.025,
      letterSpacing: 1,
      fontWeight: FontWeight.w500,
  ...
  TextStyle createAccountTextStyle({required Size size}) {
    return TextStyle(
  ...
  // ** create Account text style
  TextStyle togetherCreateTextStyle({required Size size}) {
    return TextStyle(
  ...
  // ** create Account text style
  TextStyle userNameTextStyle({required Size size}) {
    return TextStyle(
