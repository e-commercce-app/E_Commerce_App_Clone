...
import 'package:e_commerce/feature/User_Side/Screens/Navigation_Bar_Screens/Profile_Page/custom_profile_app_bar.dart';
...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final email = userDetails.emailAddress ??
        FirebaseServices.currentUser!.email.toString();
    final phone = userDetails.phoneNumber ?? '+92032467...';
    final password = userDetails.password ?? '1234567';
    return Scaffold(
